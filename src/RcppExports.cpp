...
RcppExport SEXP _XYomics_call_sr(SEXP fromSEXP, SEXP toSEXP, SEXP costSEXP, SEXP node_namesSEXP, SEXP node_prizesSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_XYomics_call_sr", (DL_FUNC) &_XYomics_call_sr, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_XYomics(DllInfo *dll) {
